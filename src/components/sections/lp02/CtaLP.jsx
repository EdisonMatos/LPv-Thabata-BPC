...
export default function AboutParalaxeLP() {
  return (
    <div
      ...
      style={{
        backgroundImage: `url(${contentLp02.cta.bgImg})`,
          ...
          <SectionArea className="">
            <SectionWrapper>
              <SectionHeader
                ...
                miniTitle={contentLp02.cta.sectionHeader.miniTag}
                sectionHeaderTitle={contentLp02.cta.sectionHeader.title}
                sectionHeaderSubtitle={contentLp02.cta.sectionHeader.subtitle}
                color=""
              />
              <MotionDivDownToUp>
                <Button
                  aria-label={contentLp02.hero.textArea.ctaButtonAriaLabel}
                  label={contentLp02.cta.buttonLabel}
